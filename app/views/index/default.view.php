  ...
  <div class="panel-group">
    ...
    <div class="col-md-4">
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <a href="/teatcher">نافذة المدرسين <span><i class="fas fa-cog"></i></span></a>
            </div>
        </div>
    </div>
...
<ul>
    ...
    <li><a href="/teatcher/add"> إضافة مدرس جديد<span><i class="fa fa-plus-circle"></i></span></a></li>
    ...
    <li><a href="#">النتـــــــائــــــــج <span><i class="far fa-plus-square"></i></span></a></li>
